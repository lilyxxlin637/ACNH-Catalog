...
export const AppIconsPack = {
  ...
  icons: {
    ...
    'fish': IconProvider(require('../assets/images/icon-fish.png')),
    'insects': IconProvider(require('../assets/images/icon-insects.png')),
    'fossils': IconProvider(require('../assets/images/icon-fossils.png')),
    'diy': IconProvider(require('../assets/images/icon-diy.png')),
    'furniture': IconProvider(require('../assets/images/icon-furniture.png')),
    'clothes': IconProvider(require('../assets/images/icon-clothes.png')),
